...
Rekonstruksi Balik secara Sekuensial di Backend (IDCT & Konversi RGB)
       │
       ▼
Penyimpanan Berkas sebagai PNG Baru
       │
       ▼
Kirim Berkas Gambar PNG Kecil langsung ke Frontend (untuk pratinjau & unduh)
```
...
│   ├── tests/
│   │   └── test_algorithms.py      # Unit test Huffman, DCT, dan LSB
...
| **Codec DCT** | Gambar | `.png`, `.bmp` | `.png` | Kompresi lossy domain frekuensi; backend langsung rekonstruksi (IDCT) dan mengembalikan gambar `.png` |
